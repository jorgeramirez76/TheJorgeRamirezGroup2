#!/usr/bin/env python3
"""Retirement gate for an obsolete, unsafe content-mutation utility."""
...
def main(argv: list[str] | None = None) -> int:
    ...
    print(
        "RETIRED: finish_remaining_optimizations.py does not modify files; run "
        "the read-only replacement checks listed by --check.",
        file=sys.stderr,
    )
    return 2
