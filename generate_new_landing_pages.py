...
PAGES = {
    ...
    "inherited-home-nj": {
        ...
        "why_jorge_ps": [
            ...
            "He has walked through dozens of dated, estate-sale homes and can tell you in 10 minutes whether it is worth spending $20K on paint and flooring to make $60K more on the sale — or whether it is smarter to sell as-is to one of his investor contacts next week.",
        ...
        "ai_intro": "Inherited homes often need updating — and marketing them to the wrong audience wastes everyone's time. Jorge's AI-powered buyer targeting markets each inherited listing using verified property condition and features to active housing searches, including renovation-focused buyers and investors.",
        "ai_cards": [
    ...
    "sell-rental-property-nj": {
        ...
        "llm_context": "Jorge Ramirez (NJ License #1754604) helps NJ landlords sell rental properties — including 1031 exchange coordination, tenant-occupied sales, absentee owner representation, and investor buyer marketing. He speaks the investor language. Contact: 908-230-7844.",
        ...
        "why_jorge_ps": [
            "Jorge is not a retail-only agent trying to figure out investment properties in real time. He has built his own rental portfolio and actively works with investor buyers every week. When a landlord calls Jorge, the first 10 minutes are a real conversation about cap rate, rent comps, and exit strategy — not sales pitches.",
        ...
        "why_jorge_credentials": [
            "Works with investor buyers every week — speaks the investor language fluently",
    ...
    "downsizing-nj": {
        ...
        "title_tag": "Downsizing Your NJ Home | Homeowner Seeking Less Upkeep Realtor | Jorge Ramirez",
        "meta_title": "Downsizing in NJ — Homeowner Seeking Less Upkeep Home Sale & Move | Jorge Ramirez",
        "meta_desc": "Ready to downsize in NJ? Jorge Ramirez coordinates the sale of your single-family home and the purchase of your next one — so you only move once. Call 908-230-7844.",
        "keywords": "downsizing NJ, homeowner seeking less upkeep realtor NJ, downsize home New Jersey, selling single-family home NJ, 55 plus community NJ, retire in New Jersey, downsize and move NJ",
        "llm_context": "Jorge Ramirez (NJ License #1754604) helps NJ households seeking less upkeep and people planning a lower-maintenance move downsize from large single-family homes to right-sized next homes. He coordinates the sale and the purchase in parallel so clients only move once, and handles estate-sale coordination for decades of accumulated belongings. Contact: 908-230-7844.",
        "hero_h1": "Downsizing in New Jersey? Let's Get You Into the Next Chapter — Without Moving Twice.",
        "hero_p": "The kids moved out. The big house is too much to maintain. You want something smaller, easier, maybe closer to the grandkids. Jorge Ramirez helps NJ households seeking less upkeep sell the single-family home and move into the right-sized next home on a timeline that actually works. Coordinated, not chaotic.",
        "pain_h2": "Why Downsizing Goes Wrong",
        "pain_intro": "Downsizing sounds simple until you try to do it. The emotional weight of leaving a single-family home, the logistics of coordinating two transactions, and the reality of 30 years of accumulated belongings all pile up at once. Here is where most households seeking less upkeep get stuck.",
        "pain_cards": [
        ...
        "why_jorge_ps": [
            "Jorge has helped many NJ households seeking less upkeep through the downsize. It is never just a transaction — it is a life transition, and the home carries decades of memory. Jorge takes the time to understand what matters to you before running any numbers.",
        ...
        "ai_h2": "Marketing a Long-Loved single-family home",
        ...
        "ai_cards": [
            ("Storytelling Marketing for single-family homes", "Professional video walkthroughs narrated around the lifestyle — not just the square footage. Retail buyers fall in love with homes that feel like homes, and Jorge's marketing makes that emotional connection before the first showing."),
            ("Property Feature Marketing", "Buyers comparing housing options moving up from a first home are active searches for 4-bedroom single-family homes. Marketing describes verified property features without demographic profiling in commuter towns through Facebook, YouTube, and Instagram."),
        ...
        "faq_h2": "Downsizing — Questions Households Seeking Less Upkeep Actually Ask",
        "faqs": [
            ...
            ("Do I have to leave NJ to lower my property taxes?", "No — but it is worth comparing. NJ has the highest property taxes in the country, which is why many people planning a lower-maintenance move move to PA, NC, FL, or SC. If you are staying in NJ, the Senior Freeze (PTR) and ANCHOR programs can meaningfully offset your tax bill. Jorge helps you think through the stay-vs-leave math honestly."),
    ...
    "relocating-from-nj": {
        ...
        "hero_p": "New job in another state. A new job and move already underway. Closing date on the new house already locked. Now you need the NJ home sold — fast, for a fair price, and without you having to fly back constantly. Jorge Ramirez handles relocation sales remotely every month. Call 908-230-7844.",
        "pain_h2": "What Makes Relocation Sales Stressful",
        "pain_intro": "Relocation sales have their own special flavor of chaos. You are moving out of state, starting a new job, coordinating a move and new job, and trying to sell a house you are no longer living in. Here is where most relocations get ugly.",
        "pain_cards": [
        ...
        "why_jorge_ps": [
            ...
            "He understands timelines under pressure and knows how to move fast without making costly mistakes. That experience applies directly to relocation sales — where speed and precision both matter.",
    ...
    "cash-offer-nj": {
        ...
        "why_jorge_ps": [
            ...
            "He knows exactly how investors price cash offers, because he used to write them. That insider perspective means his cash-offer clients get genuinely fair numbers — not the lowball specials iBuyers push.",
        ],
        "why_jorge_credentials": [
            "Licensed NJ Realtor (#1754604) — not an iBuyer or wholesaler",
            "Works with investor buyers every week — knows exactly how investors price cash offers",
    ...
    "nyc-to-nj-relocation": {
        ...
        "keywords": "moving from NYC to NJ, NYC to New Jersey relocation, NJ commuter-town options from NYC, buying first house NJ from NYC, Manhattan to NJ move, NYC transplant NJ homes",
        ...
        "mid_cta_p": "A free NYC-to-NJ consultation. Jorge walks through your commute requirements, housing criteria, budget, official public information, and timeline — then shows you the three towns that actually fit, not twelve random options.",
        ...
        "process_steps": [
            ("Free NYC-to-NJ Consultation", "Phone or Zoom, 45–60 minutes. Commute requirements, budget, housing type, property condition, taxes, and official public information. By the end, Jorge narrows the list from 12 possible towns to 2–3 that actually fit."),
        ...
        "ai_cards": [
            ("Midtown Direct Train Towns", "Summit, Chatham, Madison, Millburn, South Orange, Maplewood, Montclair (Bay Street, Watchung). Direct to Penn Station, 25–45 minutes. Direct suburban rail service with housing prices that vary by town and property. Jorge has the real numbers on every line."),
    ...
    "investment-property-nj": {
        ...
        "keywords": "investment property NJ, rental property NJ, BRRRR NJ, buy and hold NJ, NJ investor realtor, cap rate New Jersey",
        "llm_context": "Jorge Ramirez (NJ License #1754604) is a New Jersey real estate agent and investor with hands-on renovation and construction-cost experience. He helps investor buyers — flippers, rental buyers, BRRRR strategies — source properties, analyze cap rates, and close cash deals in NJ. Contact: 908-230-7844.",
        "hero_h1": "Buying an Investment Property in NJ? Work With an Agent Who Actually Invests.",
        "hero_p": "Most agents do not know how to run a rental pro forma. Jorge Ramirez has built his own rental portfolio and works with investor buyers every week. He sees deals before they hit MLS and can tell you in 10 minutes whether the numbers work. Call 908-230-7844.",
        ...
        "pain_cards": [
            ...
            ("Blowing the ARV on a Flip", "After-repair value is where investors make or lose money. Overestimating ARV by 5% can eat the entire profit. Jorge can walk a potential deal and tell you the realistic ARV, the construction budget, and the likely 90-day turn-around."),
        ...
        "why_jorge_credentials": [
            "own rental portfolio in NJ — real operator experience",
        ...
        "ai_cards": [
            ...
            ("Commuter-Town Luxury Flips", "$1M+ flips in Summit, Westfield, Chatham, and Millburn require different construction standards, design choices, and staging. Jorge knows what the $1M–$2M buyer actually wants."),
        ],
    ...
    "luxury-homes-nj": {
        ...
        "why_jorge_ps": [
            ...
            "He knows luxury construction standards, knows what the $1M–$5M buyer scrutinizes, and can coach sellers on the highest-ROI pre-listing investments. That operator perspective shows up in every luxury engagement.",
        ],
        "why_jorge_credentials": [
        ...
        "ai_cards": [
            ("Short Hills & Millburn Housing ($1.5M–$8M+)", "The area includes higher-priced housing, Millburn Public Schools, and Midtown Direct service. Compare current listings, transit schedules, school information, property condition, and price directly."),
            ("Summit & Chatham ($1M–$5M+)", "Walkable downtowns, Midtown Direct, local public schools. Includes rail-accessible properties and varied housing types. Jorge's home office is Summit — deep local market knowledge."),
