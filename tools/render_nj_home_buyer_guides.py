...
CONTENT = {
    ...
    "es": {
        ...
        "search_href": "/es/property-search",
        ...
        "footer_buyer_links": [("Comprar vivienda", "/es/buy-a-home"), ("Buscar propiedades", "/es/property-search"), ("Programas NJHMFA", "/es/blog/first-time-home-buyer-nj-guide"), ("Calculadora hipotecaria", "/es/tools/mortgage-calculator"), ("Planificador de cierre", "/es/closing-costs-calculator")],
        "copyright": "© 2026 The Jorge Ramirez Group · Keller Williams Premier Properties.",
