#!/usr/bin/env python3
"""Retirement gate for an obsolete, unsafe internal-link mutation utility."""
...
REPLACEMENT_CHECKS = (
    ...
    "python3 -m unittest tests.test_full_surface_technical_contract",
...
def main(argv: list[str] | None = None) -> int:
    ...
    print(
        "RETIRED: internal_links.py does not modify files; use reviewed, "
        "source-owned navigation and the read-only checks listed by --check.",
        file=sys.stderr,
    )
    return 2
